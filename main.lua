...
function love.load()
  ...
  love.frame=0
  gametitle=love.graphics.newImage('title01.png')
  menuback=love.graphics.newImage('stars2.jpg')
  -------------games states------------------------
  home_door={}
  home_door.image=love.graphics.newImage("home_icon.jpg")
  ...
  --------------------------------------------------------
  --------------Audio files------------------------------
  shoot=love.audio.newSource("Laser Gun Sound Effect.mp3","stream")
  shootpowerup=love.audio.newSource("Machine-Gun-Automatic-Fire-A-www.fesliyanstudios.com.mp3","stream")
  collide=love.audio.newSource("mixkit-arcade-mechanical-bling-210.wav","stream")
  powerup=love.audio.newSource("mixkit-retro-arcade-casino-notification-211.wav","stream")
  death=love.audio.newSource("mixkit-arcade-retro-game-over-213.wav","stream")
  ----------------------------------------------------------
  --------------------Graphics------------------------------
  enemy_image=love.graphics.newImage("ast.png")
  background_image=love.graphics.newImage("try.png")
  -----------------------------------------------------------
  --------------highscore------------------------------------
